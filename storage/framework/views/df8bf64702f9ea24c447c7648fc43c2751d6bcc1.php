...
<hr>
   ...
   <div class="row">
    ...
    <div class="card text-center">
      <div class="card-header">
        出勤：<?php echo e($item->punchIn); ?>

      </div>
      <div class="card-body">       
        <p class="card-text">退勤：<?php echo e($item->punchOut); ?></p>
        
      </div>
      <div class="card-footer text-muted">
        勤務時間：<?php echo e($item->workTime); ?>時間
      </div>
    </div>
  </div>
 ...
 <?php /**PATH C:\MAMP\htdocs\test_17\laravel8_vue_calendar\resources\views/time/performance.blade.php ENDPATH**/ ?>